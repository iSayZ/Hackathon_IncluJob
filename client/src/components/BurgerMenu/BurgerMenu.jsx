        ...
        <div className={isOpen ? "burger_menu open" : "burger_menu"}>
            ...
            <div className="burger_menu_container">
                <nav className="nav_burger_menu">
                    ...
                    <Link to="/" aria-label="Aller vers la rubrique : 'Recherche un emploi'">Recherche un emploi</Link>
                    <Link to="/" aria-label="Aller vers la rubrique : 'Notre concept'">Notre concept</Link>
                    <Link to="/" aria-label="Aller vers la rubrique : 'Nous contacter'">Nous contacter</Link>
                    <br />
                    <br />
                    <button className="no_btn zoom" type="button" onClick={togglePopup} aria-label="Ouvrir le menu : 'Paramètres d'accessibilité'">Paramètres d'accessibilité</button>
                </nav>
            </div>
        </div>
    )
