...
('Handicap Moteur', 'http://example.com/pictogram_handicap_moteur.png'),
('Handicap Visuel', 'http://example.com/pictogram_handicap_visuel.png'),
('Handicap Auditif', 'http://example.com/pictogram_handicap_auditif.png'),
('Handicap Psychique', 'http://example.com/pictogram_handicap_psychique.png'),
('Déficience Intellectuelle', 'http://example.com/pictogram_deficience_intellectuelle.png'),
('Maladies Invalidantes', 'http://example.com/pictogram_maladies_invalidantes.png');
